...
public class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.MyViewHolder> {
    ...
    public HomeAdapter(Context c, List<MenuModel> data) {
        this.dataSet = data;
        mContext = c;
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int listPosition) {
        ...
        pCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (dataSet.get(listPosition).Transporte != null && dataSet.get(listPosition).Transporte.length() > 0) {
                    Bundle bundle = new Bundle();
                    bundle.putString(dataSet.get(listPosition).Transporte, String.valueOf(dataSet.get(listPosition).IdMenu));
